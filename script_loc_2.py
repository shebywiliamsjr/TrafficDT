...
def process_video(video_path, conf_threshold=0.7):
    ...
    regions = {
        "north": {"points": [(width // 3, height // 10 - 50), (width // 2 + 100, height // 10 - 50) , (width // 2 + 100, height // 6), (width // 2 - 200, height // 4)], "color": (255,0,0)}, # Blue
        "east": {"points": [(width // 2 + 350,  height // 7 - 50), (width // 2 + 450, height // 7) , (width // 2 + 250, height // 3 + 50) , (width // 2 + 100, height // 3  - 160)], "color": (210, 52, 235)}, # Green
        "south": {"points": [(width // 2 - 400,  height - 250 ), (width - 370 , height // 2 - 50) , (width , height) , (width // 2 - 450, height)], "color": (0,0,255)}, # Red
        "west": {"points": [(0,  height // 2 - 240 ), (width // 4 + 120,  height // 2 - 200) , (width // 2 - 350, height - 280) , (0, height)], "color": (255,255,0)}, # Cyan
    }
